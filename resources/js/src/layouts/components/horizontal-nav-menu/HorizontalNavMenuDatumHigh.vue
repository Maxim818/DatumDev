<template>
  <div class="relative">
    <div class="vx-navbar-wrapper nav-menu-wrapper" style="background-color: #3A3A3A; padding-left: 150px;">
        ...
        <ul class="menu-items flex flex-wrap w-full items-center">
          <li
            ...
            <template v-else-if="item.submenu">
              <h-nav-menu-group
                class="menu-group relative py-4 py-datum"
                bottom
                :key        ="`group-${index}`"
                :group      ="item"
                :groupIndex ="index"
            ...
            <div v-else-if="item.url" class="menu-link">
              <h-nav-menu-item
                class       = "relative py-4 cursor-pointer py-datum"
...
import HNavMenuItem   from "./HorizontalNavMenuItemDatumHigh.vue"
import SearchBar      from "../navbar/components/SearchBarTest.vue"
...
<style lang="scss">
@import "@sass/vuexy/components/horizontalNavMenuDatum.scss"
</style>

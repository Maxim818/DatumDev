<template>
  <div class="flex mx-auto">
    <div class="search-full-container w-full h-full" :class="{'flex': showFullSearch}" v-show="showFullSearch">
      <vx-auto-suggest
        ref="navbarSearch"
        ...
        @selected="selected"
        @closeSearchbar="showFullSearch = true">
    ...
    <feather-icon icon="SearchIcon" class="ml-4" style="color: white !important" />

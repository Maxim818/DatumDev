...
import HNavMenu            from "@/layouts/components/horizontal-nav-menu/HorizontalNavMenuDatumHigh.vue"
import navMenuItems        from "@/layouts/components/vertical-nav-menu/navMenuItems_datum.js"
import TheCustomizer       from "@/layouts/components/customizer/TheCustomizer.vue"
import TheNavbarHorizontal from '@/layouts/components/navbar/TheNavbarHorizontalTest.vue'
import TheNavbarVertical   from '@/layouts/components/navbar/TheNavbarVerticalTest.vue'
import TheFooter           from '@/layouts/components/TheFooterDatum.vue'
import themeConfig         from '@/../themeConfigTest.js'
import VNavMenu            from '@/layouts/components/vertical-nav-menu/VerticalNavMenuTest.vue'
import HDetailMenu            from '@/layouts/components/horizontal-nav-menu/HorizontalDetailMenu.vue'

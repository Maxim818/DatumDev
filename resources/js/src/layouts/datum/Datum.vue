<!-- =========================================================================================
    File Name: Datum.vue
    Description: Datum layout
    ----------------------------------------------------------------------------------------
    Item Name: Vuexy - Maxim
    Author: Maxim
    Author Email: maxim.gregory1@gmail.com
========================================================================================== -->
...
import TheNavbarHorizontal from '@/layouts/components/navbar/TheNavbarHorizontalDatum.vue'
import TheNavbarVertical   from '@/layouts/components/navbar/TheNavbarVerticalDatum.vue'
import TheFooter           from '@/layouts/components/TheFooterDatum.vue'
import themeConfig         from '@/../datumConfig.js'

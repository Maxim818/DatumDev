        ...
        <div class="header-sidebar flex items-end justify-between" slot="header">
          ...
          <div>
            ...
            <template v-if="showCloseButton">
              <feather-icon icon="XIcon" class="m-0 cursor-pointer" @click="$store.commit('TOGGLE_IS_VERTICAL_NAV_MENU_ACTIVE', false)" style="color: #9D2E2E !important;" />
            </template>
...
import VNavMenuItem from '@/datum/layouts/components/navbar/VerticalNavMenuItem.vue'

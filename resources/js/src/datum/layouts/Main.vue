<!-- =========================================================================================
    ...
    ----------------------------------------------------------------------------------------
    Item Name: Main Layout Template
    Author: Maxim
    Author URL: maxim.gregory1@gamil.com
========================================================================================== -->


<template>
  <div class="layout--datum" :class="[layoutTypeClass, navbarClasses, footerClasses, {'no-scroll': isAppPage}]">
...
<!-- 
    ...
    <template v-if="mainLayoutType === 'horizontal' && windowWidth >= 1200">
      ...
      <h-detail-menu :navMenuItems="detailMenuItems" />
        ...
        <div class="router-view">
          <div class="router-content">            
            ...
            <div class="content-area__content">
              ...
              <back-to-top bottom="10%" :right="$vs.rtl ? 'calc(100% - 2.2rem - 38px)' : '30px'" visibleoffset="500" v-if="!hideScrollToTop">
...
<script>
import TheNavbarHorizontal from '@/datum/layouts/components/navbar/TheNavbarHorizontal.vue' // Top Horizontalbar
import HNavMenu            from "@/datum/layouts/components/navbar/HorizontalNavMenu.vue" // Main Navbar Menu
...
import VNavMenu            from '@/datum/layouts/components/navbar/VerticalNavMenu.vue' // Vertical Navmenu

import TheFooter           from '@/datum/layouts/components/TheFooter.vue' // Footer
import themeConfig         from '@/datum/config/themeConfig.js' // Main Setting
